...
const ProfilePage = () => (
  <ProfileContainer>
    <ContactButton to="/user/homepage/contact">Contact Us</ContactButton>
    <ProfileHeader>B.planet</ProfileHeader>
    <ProfileBox>
      <ProfileImage src={profilePic} alt="Profile Picture" />
      <ProfileField>
        <ProfileLabel>Name</ProfileLabel>
        <ProfileInfo>Rahul Kumar</ProfileInfo>
      </ProfileField>
      <ProfileField>
        <ProfileLabel>Email</ProfileLabel>
        <ProfileInfo>rahulkumar@gmail.com</ProfileInfo>
      </ProfileField>
      <ProfileField>
      ...
      <ProfileField>
        ...
        <ProfileInfo>9598755687</ProfileInfo>
      </ProfileField>
      <ProfileField>
